...
class Lexer:
    ...
    KEYWORDS = {
        ...
        "RANDOM_LOWERCASE_LETTER": Tok.RANDOM_LOWERCASE_LETTER,
        "RANDOM_UPPERCASE_LETTER": Tok.RANDOM_UPPERCASE_LETTER,
        "RANDOM_LETTER": Tok.RANDOM_LETTER,
        "RANDOM_NUMBER": Tok.RANDOM_NUMBER,
        "RANDOM_SPECIAL": Tok.RANDOM_SPECIAL,
