...
def test_expression(lexer):
    ...
    expected_tokens = [
        Token(TokenType.VAR, "VAR", 1, 1),
        Token(TokenType.ID, "$y", 1, 5),
        Token(TokenType.ASSIGN, "=", 1, 8),
        Token(TokenType.ID, "$x", 1, 10),
